        ...
        <div class="container">
            <div class="row justify-content-center mb-5">
                <div class="col-lg-8 text-center">
                    ...
                    <p class="lead-text">
                        No <strong>Javier Cabelo & Estética</strong>, oferecemos uma experiência única e personalizada de beleza e bem-estar. 
                        Nossa missão é proporcionar um atendimento excepcional em um ambiente acolhedor e moderno no coração da Vila Romana.
                    </p>
                </div>
            </div>
            ...
            <div class="row align-items-center mt-5">
                <div class="col-md-6 mb-4 mb-md-0">
                    <div class="history-image-container">
                        <img src="{{ asset('img/frentesalao1.jpg') }}" class="img-fluid rounded shadow-lg" alt="Frente do Salão">
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="history-text ps-md-4">
                        ...
                        <p>Ao longo dos anos, ampliamos nossa gama de serviços e conquistamos a confiança de um público que busca não apenas beleza, mas também cuidado personalizado e profissionalismo.</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section id="sobre-equipe" class="staff-section py-5">
        <div class="container">
            ...
            <div class="staff-grid" data-aos="zoom-in" data-aos-duration="1400" data-aos-delay="400">
                ...
                <x-equipe image="{{ asset('img/manu.jpg') }}" alt="Manuela" 
                    specialty="Cabeleireira e Maquiadora" name="Manuela" />
            </div>
        </div>
    </section>
